...
- [~] Migraciones 001–037 en Supabase (proyecto "GDC", vía `gdc/supabase/migrations/` + `supabase db push`) — 024 a 030 corresponden a la ficha OT-02, 031 a 036 a la ficha OT-03 (ver más abajo). Las 001–036 están aplicadas y verificadas; la **037 (`20260823110001_expedientes_update_juez_asistente`) está escrita pero PENDIENTE de aplicar** — ver la última entrada de este checklist
