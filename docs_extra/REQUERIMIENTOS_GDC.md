...
- [~] Migraciones 001–043 en Supabase (proyecto "GDC", vía `gdc/supabase/migrations/` + `supabase db push`) — 024 a 030 corresponden a la ficha OT-02, 031 a 036 a la ficha OT-03 (ver más abajo). Las 001–036 están aplicadas y verificadas; las **037 a 043 están escritas pero PENDIENTES de aplicar** (`20260823110001_expedientes_update_juez_asistente`, `20260823120001_dias_no_habiles`, `20260823130001_plazo_contestacion`, `20260823140001_plazos_ejecutivos`, `20260823150001_audiencia_especial`, `20260823160001_estado_proceso`, `20260823170001_plazo_edicto_sucesiones`) — ver las últimas entradas de este checklist
